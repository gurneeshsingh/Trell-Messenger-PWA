...
const ChatBoxTopHeader = ({ activeChat, fetchMessages, fetchAgain, setFetchAgain, singlechatMobileView, setSinglechatMobileView }) => {
    ...
    return (
        ...
        <>
            ...
            {/* // for mobile screen */}
            <div className='flex md:!hidden w-full !h-[12vh]'>
                <AppBar position='static' color='transparent' sx={{ boxShadow: "none", width: "100%" }}>
                    <Toolbar sx={{ borderBottom: "1px solid rgb(209 213 219)", display: "flex", alignItems: "center", marginTop: "15px", marginBottom: "5px", paddingBottom: "10px" }}>
                        <IconButton size='small' edge="end" color='secondary' sx={{ marginRight: "14px" }} onClick={goBackToChats}>
